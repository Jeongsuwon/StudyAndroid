package com.example.ym01_designtemplate.dialog;
...
public class DialogActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSimpleDialog = new MaterialDialog.Builder(this)
                ...
                .setPositiveButton("Delete", R.drawable.ic_delete, new MaterialDialog.OnClickListener() {
                    @Override
                    public void onClick(com.example.ym01_designtemplate.dialog.interfaces.DialogInterface dialogInterface, int which) {
        ...
        mSimpleBottomSheetDialog = new BottomSheetMaterialDialog.Builder(this)
                ...
                .setPositiveButton("Delete", R.drawable.ic_delete, new BottomSheetMaterialDialog.OnClickListener() {
                    @Override
                    public void onClick(com.example.ym01_designtemplate.dialog.interfaces.DialogInterface dialogInterface, int i) {
    ...
    public void onClick(View view) {
        if(view.getId() ==R.id.button_simple_dialog ){
            mSimpleDialog.show();
        }else if(view.getId() ==  R.id.button_simple_bottomsheet_dialog){
            mSimpleBottomSheetDialog.show();
        }else if(view.getId() == R.id.button_animated_dialog){
            mAnimatedDialog.show();
        }else if(view.getId() == R.id.button_animated_bottomsheet_dialog){
