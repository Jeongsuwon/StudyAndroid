...
public class ChartFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.gridGenre.setAdapter(new GridAdapter(genre(), getContext()));
    ...
    public ArrayList<FloChartDTO> getForeignChart(){
        ...
        list.add(new FloChartDTO(R.drawable.chart_img1, R.drawable.play, 1, "vampire (Explicit Ver.)", "Olivia Rodrigo"));
        list.add(new FloChartDTO(R.drawable.chart_img2, R.drawable.play, 2, "Cruel Summer", "Taylor Swift"));
        list.add(new FloChartDTO(R.drawable.chart_img3, R.drawable.play, 3, "Calm Down", "Rema&Selena Gomez"));
        list.add(new FloChartDTO(R.drawable.chart_img4, R.drawable.play, 4, "Ella Baila Sola", "aespa"));
        list.add(new FloChartDTO(R.drawable.chart_img5, R.drawable.play, 5, "Flowers", "IVE (아이브)"));
        list.add(new FloChartDTO(R.drawable.chart_img6, R.drawable.play, 6, "La Bebe (Remix) (Explicit Ver.)", "LE SSERAFIM (르세라핌)"));
        list.add(new FloChartDTO(R.drawable.chart_img7, R.drawable.play, 7, "Creepin' (Explicit Ver.)", "임영웅"));
        list.add(new FloChartDTO(R.drawable.chart_img8, R.drawable.play, 8, "Fast Car", "임영웅"));
        list.add(new FloChartDTO(R.drawable.chart_img9, R.drawable.play, 9, "I Wanna Be Yours", "NewJeans"));
        list.add(new FloChartDTO(R.drawable.chart_img10, R.drawable.play, 10, "SABOR FRESA (Explicit Ver.)", "임영웅"));
        list.add(new FloChartDTO(R.drawable.chart_img11, R.drawable.play, 11, "퀸카(Queencard)", "(여자)아이들"));
        list.add(new FloChartDTO(R.drawable.chart_img12, R.drawable.play, 12, "Ditto", "NewJeans"));
        list.add(new FloChartDTO(R.drawable.chart_img13, R.drawable.play, 13, "헤어지자 말해요", "박재정"));
        list.add(new FloChartDTO(R.drawable.chart_img14, R.drawable.play, 14, "이제 나만 믿어요", "임영웅"));
