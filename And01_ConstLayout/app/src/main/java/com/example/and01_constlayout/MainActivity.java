...
public class MainActivity extends AppCompatActivity {
    ...
    //(클래스는 대문자로 시작: 'I'mageView, 'B'utton
    ImageView imgv_jsw; //전역 변수 선언 초기상태 null
    @Override
...
//        imgv_jsw=findViewById(R.id.imgv_jsw);//@IdRes== R클래스에서 내용을 찾아서 넣어주세요. ctrl + p
//
//        //인터페이스 옵저버 패턴
//        imgv_jsw.setOnClickListener(new View.OnClickListener() {
//            @Override
...
//        //옵저버 패턴: 인터페이스는 내부에 만들어 둔 메소드를 만드시 구현해야하는 속성이 있다.(abstract)
//        //인터페이스를 파라미터로 입력받게 만들고, 특정한 처리가 일어나면 내부에 구현해놓은 메소드를 대신 실행한다.
//
//        JswOnClickListener onClickListener = new JswOnClickListener() {
//            @Override
//            public void onClick(String data) {
//                Toast.makeText(MainActivity.this, "메소드는 실행되었습니다.JSW", Toast.LENGTH_SHORT).show();
//            }
//        };
...
//    public interface JswOnClickListener{
//        public void onClick(String data);
//    }
}